...
import { User, Mail, Building2, Camera, Key, Eye, EyeOff, Briefcase } from "lucide-react";
...
function Profile() {
  ...
  return (
    <div style={containerStyle}>
      <h2 style={{ marginBottom: "20px", alignSelf: "flex-start", width: "100%", maxWidth: "500px" }}>HOD Profile</h2>
      <div style={cardStyle}>
        ...
        <div style={gridStyle}>
          {userInfo.email && (
            <div style={detailRowStyle}>
              <div style={iconBoxStyle}><Mail size={18} color="#DC2626" /></div>
              <div>
          ...
          {userInfo.employeeID && (
            <div style={detailRowStyle}>
              <div style={iconBoxStyle}><Briefcase size={18} color="#DC2626" /></div>
              <div>
          ...
          {userInfo.department && (
            <div style={detailRowStyle}>
              <div style={iconBoxStyle}><Building2 size={18} color="#DC2626" /></div>
              <div>
